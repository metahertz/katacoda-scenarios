...
until checkov -f ${WORKSHOP_HOMEDIR}/kustomizegoat/kustomize/base/service.yaml --framework kubernetes --bc-api-key ${2} ; do sleep 2; echo "Waiting on checkov API key run..." ; done
